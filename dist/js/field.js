...
Nova.booting(function (Vue, router, store) {
  Vue.component('index-simple-button', __webpack_require__(3));
  Vue.component('detail-simple-button', __webpack_require__(6));
  Vue.component('form-simple-button', __webpack_require__(9));
});
  ...
  return _c("div", { staticClass: "flex" }, [
    ...
    _c("div", { staticClass: "w-1/5 px-8 py-6" }, [
      _c(
        ...
        {
          staticClass:
            "relative inline-flex items-center btn btn-default btn-primary",
          attrs: {
            href: this.field.link,
            type: "button",
            dusk: "update-button",
            target: "_blank"
          }
        },
        [_c("span", [_vm._v(" " + _vm._s(this.field.text) + " ")])]
      )
    ])
  ])
}
